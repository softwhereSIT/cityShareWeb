...
<head>
    ...
    <link rel="stylesheet" href="css/style_addCategoria.css"/>
...
<section id="dv_principal">
    ...
    <main>
        ...
        <form name="frm_cadastro_cat" method="post" action="addCategoria_view.php">
            <div id="dv_cadastro">
                <div id="dv_tabela">
                    <div class="dv_texto">
                        <label for="in-categoria" class="texto">
                            Categoria
                        </label>
                    </div>
                    <div class="dv_input">
                        <input type="text" name="in-categoria" class="input">
                    </div>
