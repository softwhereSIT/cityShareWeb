...
<head>
    ...
    <!-- Estilo da página -->
    <link rel="stylesheet" href="css/style_AddEspecificos.css"/>
...
<section id="dv_principal">
    ...
    <main>
        <div id="dv_titulo">
            <h1>Adicionar Atributos Especificos</h1>
        </div>
        <form name="frm_cadastro_esp" method="post" action="addEspecificos_view.php">
            <div id="dv_cadastro">
                <div id="dv_tabela">
                    <div class="dv_texto">
