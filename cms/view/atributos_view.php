...
<head>
    ...
    <link rel="stylesheet" href="css/style_atributos.css"/>
...
<section id="dv_principal">
    ...
    <main>
        ...
        <form name="frm_registros_categoria" method="post" action="atributos_view.php">

            <div id="dv_registros">
                <div id="dv_titulo_botao">

                    <h2 id="titulo"> Atributos </h2>

                    <div id="dv_botao">

                        <a href="addAtributos_view.php"> <img src="img/add.png"> <a/>
