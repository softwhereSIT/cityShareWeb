...
<head>
    ...
    <link rel="stylesheet" href="css/style_cat_atributos.css"/>
...
<section id="dv_principal">
    ...
    <main>
        <div id="dv_titulo">
            <h1> Adicionar os Atributos das Categorias </h1>
        </div>
        <form name="frm_cat_atributo" method="post" action="categoria_atributo_view.php">
            <div id="dv_cadastro">
                <div id="dv_tabela">
