...
<head>
    ...
    <link rel="stylesheet" href="css/style_especificos.css"/>
...
<section id="dv_principal">
    ...
    <main>
        ...
        <form name="frm_registros_especificos" method="post" action="especificos_view.php">

            <div id="dv_registros">
                <div id="dv_titulo_botao">

                    <h2 id="titulo"> Atributos Especificos</h2>

                    <div id="dv_botao">

                        <a href="addEspecificos_view.php"> <img src="img/add.png"> <a/>
                    ...
                    <div>
                        <div id="dv_tabela">
                            ...
                            <div id="dv_linha_dados">
                                ...
                                <div class="dv_dados">
                                    <p class="texto"> Atributos Especificos</p>
                                </div>
